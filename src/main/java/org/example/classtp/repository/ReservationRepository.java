...
public interface ReservationRepository extends JpaRepository<Reservation, Long> {
    ...
    @Query("SELECT c FROM Reservation r JOIN r.chambres c JOIN r.etudiants e " +
            "WHERE e.cin = :cinEtudiant AND r.estValide = true")
    Set<Chambre> findChambresByCinEtudiant(@Param("cinEtudiant") Long cinEtudiant);
